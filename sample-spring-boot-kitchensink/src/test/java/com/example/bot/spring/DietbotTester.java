	...
	public void testCollectUserInformation() throws Exception {
		...
		try{
    		...
    		expectedResponse = "Hi! I am your personal Dieting Chatbot!\n"
    						...
    						+ "What is your name?";
    		chatBotReponse = stateManager.chat(userId, input, false)
    		...
    		assertThat(sql.getUserInfo(userId, "age")).isEqualTo("20");
    		assertThat(sql.getUserInfo(userId, "gender")).isEqualTo("male");
    		assertThat(sql.getUserInfo(userId, "height")).isEqualTo("176.0");
    		assertThat(sql.getUserInfo(userId, "weight")).isEqualTo("62.0");
			...
			//answer diet goal
			input = "1";
			expectedResponse = "Great, thanks for cooperating. I have a better understanding of your physical condition now. I'll try my best to help you reach your health goal!";
			chatBotReponse = stateManager.chat(userId, input, false)
    		...
    		assertThat(sql.getUserInfo(userId, "age")).isEqualTo("20");
    		assertThat(sql.getUserInfo(userId, "gender")).isEqualTo("male");
    		assertThat(sql.getUserInfo(userId, "height")).isEqualTo("181.0");
    		assertThat(sql.getUserInfo(userId, "weight")).isEqualTo("80.0");
    		assertThat(sql.getUserInfo(userId, "diet")).isEqualTo("little_diet");
